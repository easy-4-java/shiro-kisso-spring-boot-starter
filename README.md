...
> **Current Version**：`2.7.x.20241003.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
**shiro-kisso-spring-boot-starter** is a Spring Boot starter that integrates **shiro-biz** for applications using shiro-biz. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume shiro-biz capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-kisso-spring-boot-starter:2.7.x.20241003.RELEASE` |
